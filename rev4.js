...
const items = [
    { definition: "User EXEC Mode:", term: "Allows access to only a limited number of basic monitoring commands. <br> Identified by the CLI prompt that ends with the <strong>'>'</strong> symbol" },
];
